                ...
                <div class="ibox-content">
                    <form method="get" class="form-horizontal validation">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">经办人id</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">支出/收入时间</label>
                            <div class="col-sm-10">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">价格明细</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button @click="assetBorrow" class="btn btn-primary" type="button">支出</button>
                                <button @click="assetReturn" class="btn btn-default" type="button">收入</button>
                            </div>
                        </div>
                    </form>
                </div>
