const AppMenu = [
    ...
    },
    {
        ...
        list:[
            ...
            {name:"出纳登记",permission:"asset:borrow:operation",url:"/asset/borrow",staticUrl:"/model/asset/borrow.vue"}
        ]
    },
    {
        code:"Report",
    ...
    },
    {
        ...
        list:[
            ...
            {name:"凭证登记",permission:"stockTake:handle",url:"/stockTake/handle",staticUrl:"/model/stockTake/handle.vue"}
        ]
    },
    {
        code:"System",
